...
RSpec.describe "Posts features:", type: :feature do
    ...
    describe "creating a post-" do
        ...
        scenario "User creates a post without a title" do
            # Sign in as a user
            user = User.create(email: 'test@example.com', password: 'password', full_name: 'Test User', user_role: '1')
            visit new_user_session_path
            fill_in "Email", with: user.email
        ...
        scenario "User creates a post without a location" do
            # Sign in as a user
            user = User.create(email: 'test@example.com', password: 'password', full_name: 'Test User', user_role: '1')
            visit new_user_session_path
            fill_in "Email", with: user.email
        ...
        scenario "User creates a post without a start date" do
            # Sign in as a user
            user = User.create(email: 'test@example.com', password: 'password', full_name: 'Test User', user_role: '1')
            visit new_user_session_path
            fill_in "Email", with: user.email
        ...
        scenario "User creates a post without an end date" do
            user = User.create(email: 'test@example.com', password: 'password', full_name: 'Test User', user_role: '1')
            visit new_user_session_path
            fill_in "Email", with: user.email
            fill_in "Password", with: 'password'
        ...
        scenario "User creates a post without an organiser" do
            user = User.create(email: 'test@example.com', password: 'password', full_name: 'Test User', user_role: '1')
            visit new_user_session_path
            fill_in "Email", with: user.email
            fill_in "Password", with: 'password'
        ...
        scenario "User creates a post without a description" do
            user = User.create(email: 'test@example.com', password: 'password', full_name: 'Test User', user_role: '1')
            visit new_user_session_path
            fill_in "Email", with: user.email
            fill_in "Password", with: 'password'
        ...
        scenario "User creates a post without a URL" do
            user = User.create(email: 'test@example.com', password: 'password', full_name: 'Test User', user_role: '1')
            visit new_user_session_path
            fill_in "Email", with: user.email
            fill_in "Password", with: 'password'
        ...
        scenario "User creates a post without tags" do
            user = User.create(email: 'test@example.com', password: 'password', full_name: 'Test User', user_role: '1')
            visit new_user_session_path
            fill_in "Email", with: user.email
            fill_in "Password", with: 'password'
        ...
        scenario "User creates a post without selecting recurring" do
            user = User.create(email: 'test@example.com', password: 'password', full_name: 'Test User', user_role: '1')
            visit new_user_session_path
            fill_in "Email", with: user.email
            fill_in "Password", with: 'password'
        ...
        scenario "User creates a post with recurring but without recurring interval and interval unit" do
            user = User.create(email: 'test@example.com', password: 'password', full_name: 'Test User', user_role: '1')
            visit new_user_session_path
            fill_in "Email", with: user.email
            fill_in "Password", with: 'password'
        ...
        scenario "User creates a post with recurring but with recurring interval num as negative or zero and interval unit as blank" do
            user = User.create(email: 'test@example.com', password: 'password', full_name: 'Test User', user_role: '1')
            visit new_user_session_path
            fill_in "Email", with: user.email
            fill_in "Password", with: 'password'
        ...
        scenario "User creates a post with start date in the past" do
            user = User.create(email: 'test@example.com', password: 'password', full_name: 'Test User', user_role: '1')
            visit new_user_session_path
            fill_in "Email", with: user.email
            fill_in "Password", with: 'password'
        ...
        scenario "User creates a post with end date before start date" do
            user = User.create(email: 'test@example.com', password: 'password', full_name: 'Test User', user_role: '1')
            visit new_user_session_path
            fill_in "Email", with: user.email
            fill_in "Password", with: 'password'
        ...
        scenario "User creates a post with deadline before today" do
            user = User.create(email: 'test@example.com', password: 'password', full_name: 'Test User', user_role: '1')
            visit new_user_session_path
            fill_in "Email", with: user.email
            fill_in "Password", with: 'password'
    ...
    describe "editing a post-" do
        ...
        scenario "User edits a post without and leaves a required field blank" do
            user = User.create(email: 'test@example.com', password: 'password', full_name: 'Test User', user_role: '2')
            visit new_user_session_path
            fill_in "Email", with: user.email
            fill_in "Password", with: 'password'
    ...
    describe "Email posts:" do
        ...
        it "should not email a post if clear selection is clicked" do
            user = User.create(email: 'test@example.com', password: 'password', full_name: 'Test User', user_role: '2')
            visit new_user_session_path
            fill_in "Email", with: user.email
            fill_in "Password", with: 'password'
    ...
    describe "Save posts:" do
        it "should save a post to the favourites" do
            user = User.create(email: 'test@example.com', password: 'password', full_name: 'Test User', user_role: '2')
        ...
        it "should unsave a post from the favourites" do
            user = User.create(email: 'test@example.com', password: 'password', full_name: 'Test User', user_role: '2')
            user1 = User.create(email: 'test1@example.com', password: 'password', full_name: 'Test User 1', user_role: '0')
            visit new_user_session_path
            fill_in "Email", with: user.email
        ...
        it "should show that it is already saved and instead give an option to unsave" do
            user = User.create(email: 'test@example.com', password: 'password', full_name: 'Test User', user_role: '2')
            user1 = User.create(email: 'test1@example.com', password: 'password', full_name: 'Test User 1', user_role: '0')
            visit new_user_session_path
            fill_in "Email", with: user.email
